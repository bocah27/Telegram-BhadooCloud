module.exports = Object.freeze({
  TOKEN: '978530355:AAFqpPOVRGeN2nht7uI6rnvNK13RMPCkK2U', //required
  ARIA_SECRET: 'puss', //change as per needs.
  ARIA_DOWNLOAD_LOCATION: '/app/ds)', //-leave as it is
  INDEX_DOMAIN: 'https://mirrorae.workers.dev/', // replace with your index domain. use https://github.com/ParveenBhadooOfficial/go-drive
  ...
  GDRIVE_PARENT_DIR_ID:  '0AFJiWRRTOcwtUk9PVA', // for directorty eg. https://drive.google.com/drive/folders/1p7pHhSh2yboWePmo53DnVr3xkAYiojP9 use 1p7pHhSh2yboWePmo53DnVr3xkAYiojP9
  SUDO_USERS: [248749799 527295713 674076950 1071414185 416424941],	// Telegram user IDs. These users can use the bot in any chat. required, get it using https://t.me/YourTGid_Bot
  AUTHORIZED_CHATS: [-1001252787810],	// Telegram chat IDs. Anyone in these chats can use the bot. Add https://t.me/YourTGid_Bot to Group and click /id
  ...
  DOWNLOAD_NOTIFY_TARGET: {  // Information about the web service to notify on download completion. not required
    ...
    COMMANDS_USE_BOT_NAME: {
      ...
      NAME: "@Pindahbot" //Enter your Bot Username here if above is set to true.
    }
});
